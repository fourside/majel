...
const ICON_HUMIDITY = `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#4fc3f7" stroke-width="1.8" stroke-linecap="round">
  <path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"/>
  <path d="M8 14a4 4 0 0 0 4 4" stroke="#4fc3f7" stroke-width="1.2" opacity="0.5"/>
</svg>`;

const ICON_PRESSURE = `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#aaa" stroke-width="1.8" stroke-linecap="round">
  <circle cx="12" cy="12" r="9"/>
  <path d="M12 7v5l3 3"/>
  <circle cx="12" cy="12" r="1" fill="#aaa"/>
</svg>`;

const ICON_LIGHT = `<svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#fdd835" stroke-width="1.8" stroke-linecap="round">
